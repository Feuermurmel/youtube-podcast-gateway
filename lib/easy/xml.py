...
class Node:
	...
	def text(self):
		"""Iterator over the string contents of all TextNodes inside this element."""
		
		return (i.value for i in self._all() if isinstance(i, TextNode))
...
class ElementNode(Node):
	...
	def __str__(self):
		attrs = ''.join(' %s="%s"' % i for i in self.attrs.items())
