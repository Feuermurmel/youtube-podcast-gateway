...
def local_address_for_sending_to(host):
	"""Return an address of a local network socket that can be used to send data to the specified host an on which the remote host can send data to the local host."""
